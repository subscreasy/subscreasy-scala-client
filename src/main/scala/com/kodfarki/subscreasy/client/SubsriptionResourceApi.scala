...
class SubsriptionResourceApi(
   ...
   */
  def startSubscriptionUsingPOST(request: StartSubscriptionRequest): Option[SubscriptionCreateResult] = {
   ...
   *
   * @param request request 
   * @return Future(SubscriptionCreateResult)
   */
  def startSubscriptionUsingPOSTAsync(request: StartSubscriptionRequest): Future[SubscriptionCreateResult] = {
...
class SubsriptionResourceApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def startSubscriptionUsingPOST(request: StartSubscriptionRequest)(implicit reader: ClientResponseReader[SubscriptionCreateResult], writer: RequestWriter[StartSubscriptionRequest]): Future[SubscriptionCreateResult] = {
    // create path and map variables
